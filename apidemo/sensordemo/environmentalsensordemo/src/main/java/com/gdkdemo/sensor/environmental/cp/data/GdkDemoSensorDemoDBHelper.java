 ...
 */
public class GdkDemoSensorDemoDBHelper extends SQLiteOpenHelper
{
    private static final String DATABASE_NAME = "gdkdemosensordemo";
    ...
    public GdkDemoSensorDemoDBHelper(Context context) {
