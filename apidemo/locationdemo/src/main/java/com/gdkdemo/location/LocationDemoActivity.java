...
import com.gdkdemo.location.service.LocationDemoLocalService;
...
public class LocationDemoActivity extends Activity
{
    ...
    private LocationDemoLocalService locationDemoLocalService;
    private ServiceConnection serviceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.d("onServiceConnected() called.");
            locationDemoLocalService = ((LocationDemoLocalService.LocalBinder)service).getService();
        }
    ...
    {
        bindService(new Intent(this, LocationDemoLocalService.class), serviceConnection, Context.BIND_AUTO_CREATE);
        mIsBound = true;
    }
    ...
    {
        startService(new Intent(this, LocationDemoLocalService.class));
    }
    private void doStopService()
    {
        stopService(new Intent(this, LocationDemoLocalService.class));
    }
